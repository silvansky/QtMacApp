...
void MyPrivate::setDockOverlay(QWidget * overlay)
{
...
void MyPrivate::installCustomFrame()
{
...
void MyPrivate::setCustomBorderColor(const QColor & frameColor)
{
    if (gFrameColor)
        [gFrameColor release];
...
void MyPrivate::setCustomTitleColor(const QColor & titleColor)
{
    if (gTitleColor)
        [gTitleColor release];
